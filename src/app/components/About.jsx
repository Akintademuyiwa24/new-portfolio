  ...
  return (
    <div className="mb-10">
      <div className="ml-10 sm:ml-20 md:ml-32 mt-18 sm:mt-5 md:mt-0 pr-6">
        <div className="sm:flex md:flex sm:gap-2 md:gap-2 mb-10">
          <h1 className="text-white text-[24px]">
            <span className="text-blue-300 text-[18px] md:pr-2">01.</span> About
            Me
          </h1>
          <BsArrowRightCircle size={30} className="text-blue-300" />
          <BiRightArrow />
          <p>
            <span>
        ...
        {/* contents */}
        <p className="text-white md:max-w-[50%] justify-normal text-[14px] md:text-[18px]">
          Hello! My name is Brittany and I enjoy creating things that live on
          the internet. My interest in web development started back in 2012 when
          I decided to try editing custom Tumblr themes — turns out hacking
          together a custom reblog button taught me a lot about HTML & CSS!
        </p>
        <p className="text-white md:max-w-[50%] mt-8 justify-normal text-[14px] md:text-[18px]">
        ...
        <p className="text-white md:max-w-[50%] mt-8 justify-normal text-[14px]  md:text-[18px]">
          In my pursuit of growth and learning, I'm on the lookout for exciting
          opportunities that align with my front-end development skills and my
          dedication to creating web experiences that leave a lasting impact.
        </p>
